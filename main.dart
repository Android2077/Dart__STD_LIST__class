...
void main()
{
  ...
  //get__value()                               - получает значение из "итератора".
  ...
  //-------------------------------------------------------------------push_front:Начало-------------------------------------------------------------
  //Метод доабляет один элемент в начало списка.
  ...
  //-------------------------------------------------------------------push_back:Начало-------------------------------------------------------------
  //Метод доабляет один элемент в конец списка.
  ...
  //-------------------------------------------------------------------begin:Начало-------------------------------------------------------------
  //Получает "итератор" на первый элемент списка.
  ...
  //-------------------------------------------------------------------last:Начало-------------------------------------------------------------
  //Получает "итератор" на последний элемент списка.
  ...
  //----------------------------------------------------------------get__value:Начало-------------------------------------------------------------------------
   ...
   //Достает из "итератора" ранее доавбленное значние в список.
